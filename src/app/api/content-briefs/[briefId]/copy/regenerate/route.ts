...
/** 请求体校验 Schema */
const RegenerateCopyRequestSchema = z.object({
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    const parseResult = RegenerateCopyRequestSchema.safeParse(body)
    ...
    // 重新生成（消耗积分；余额预检 / 人工修改覆盖确认 / 计费均在服务层处理）
    ...
    console.error('[POST /api/content-briefs/[briefId]/copy/regenerate] 未知错误:', error)
    return NextResponse.json(
